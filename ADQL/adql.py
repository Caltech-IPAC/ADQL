...
class ADQL:
    ...
    def __init__(self, mode=SpatialIndex.HTM, level=7, encoding=None, debugfile=None, \
                 racol='ra', deccol='dec', xcol='x', ycol='y', zcol='z', indxcol=None):
    ...
    def _parseADQL(self, stmt):
        ...
        for i in range(len(stmt.tokens)):
            ...
            # done by looking a sequences of TOKENs below.  However the Identifier
            # is the best place to handle "table.column" constructs.
            ...
            # whitespace or commas).
                ...
                # First check for Closing parenthesis which trigger level change
                ...
                if(self.funcLevel == 0):
                    ...
                    elif(token.value == ')' and self.closing == False):
                        self.adql_tokens.append(str(token))
                        self.closing = False
    ...
    #         and func2 == 'polygon' and nargs2 >= 7):
        ...
        # DISTANCE FUNCTION
            ...
            if( func1 == 'point'  
            and nargs1 == 3 
            and self._is_number(args1[1]) == True 
            and self._is_number(args1[2]) == True

            and func2 == 'point' 
            and nargs2 == 3 
            and self._is_number(args2[1]) == False  
            and self._is_number(args2[2]) == False ):
